...
function buildSystemPrompt(context: AssistantProviderContext | undefined) {
  ...
  return [
    ...
    "When helpful, recommend the most specific relevant Kubera AI page from the Knowledge Base: prefer a use case, case study, GEO page, service page, blog article, how-we-work page, or contacts page over a generic answer.",
    "When you recommend pages, give one best-match recommendation first and at most two alternatives. Explain briefly why each page is relevant. Do not repeat the same recommendation unless the topic changed.",
