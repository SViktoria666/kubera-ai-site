...
export function startPageContextTracking(
  pathname: string,
  lastTrackedPathRef: { current: string },
) {
...
export function trackFallbackLinkEvent(anchor: HTMLAnchorElement) {
...
export { flushQueuedAnalyticsEvents, shouldTrackAnalyticsInBrowser };
