...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes: Array<{ route: string; priority: number }> = [
    ...
    { route: "/services/france/landing-page-design", priority: 0.81 },
    { route: "/services/netherlands/landing-page-design", priority: 0.81 },
    { route: "/services/ireland/landing-page-design", priority: 0.81 },
    { route: "/services/belgium/landing-page-design", priority: 0.81 },
    { route: "/services/italy/landing-page-design", priority: 0.81 },
    { route: "/services/switzerland/landing-page-design", priority: 0.81 },
    { route: "/services/austria/landing-page-design", priority: 0.81 },
    { route: "/services/denmark/landing-page-design", priority: 0.81 },
    { route: "/services/sweden/landing-page-design", priority: 0.81 },
    ...
    { route: "/services/latvia/landing-page-design", priority: 0.81 },
    { route: "/services/lithuania/landing-page-design", priority: 0.81 },
