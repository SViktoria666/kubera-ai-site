...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes: Array<{ route: string; priority: number }> = [
    ...
    { route: "/services/landing-page-design", priority: 0.86 },
    { route: "/services/portugal/landing-page-design", priority: 0.84 },
    { route: "/pt/services/landing-page-design", priority: 0.86 },
    { route: "/pt/services/portugal/landing-page-design", priority: 0.84 },
